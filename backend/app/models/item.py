...
class ClothingItem(Base):
    ...
    available_colors: Mapped[list] = mapped_column(JSON, nullable=False)  # JSON list of colors e.g. [{"name": "Charcoal", "hex": "#1A1A1A"}]
    images: Mapped[list] = mapped_column(JSON, nullable=False)  # JSON array of image URLs
