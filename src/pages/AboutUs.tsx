        ...
        <div className="editorial-container mx-auto max-w-[1440px] space-y-28">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5 space-y-4">
              ...
              <h1 className="font-serif text-2.5xl sm:text-4xl md:text-5xl font-light text-brand-charcoal leading-tight">
            ...
            <div className="lg:col-span-7 lg:pl-6 space-y-6">
              <p className="font-serif text-lg md:text-2xl font-light text-brand-charcoal/80 leading-relaxed italic">
                "We define color as an architectural element; we define sourcing as an act of absolute standards."
              </p>
              <p className="text-[11px] sm:text-xs text-brand-charcoal/70 tracking-wider leading-relaxed">
          ...
          <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-5 space-y-6 md:pl-6">
              ...
              <p className="text-[11px] sm:text-xs text-brand-charcoal/65 leading-relaxed tracking-wider">
          ...
          <section className="border-t border-brand-charcoal/10 pt-16">
            <div className="text-center mb-16 space-y-3">
              ...
              <h2 className="font-serif text-2xl md:text-3xl font-light text-brand-charcoal">The HUESCOUT Manifesto</h2>
            </div>
          ...
          <section className="bg-white border border-brand-concrete/30 p-8 md:p-12 text-center space-y-6 max-w-5xl mx-auto">
            ...
            <p className="text-[11px] sm:text-xs text-brand-charcoal/65 leading-relaxed tracking-wider max-w-xl mx-auto">
